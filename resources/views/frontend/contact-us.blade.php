                ...
                <form method="post" action="{{url('/')}}/contactlist">
                    ...
                    <div class="form-new">
                        <div class="form-group margin-bottom-5">
                            ...
                            <input type="text" name="name" class="form-controler name-cls" id="exampleInputName1" aria-describedby="emailHelp" maxlength="30"  placeholder="Enter Name*" required>
                        ...
                        <div class="form-group margin-bottom-5">
                            ...
                            <input type="text" pattern="[0-9]+" title="number only" name="phone" class="form-controler phone-cls" id="exampleInputPhone" maxlength="15" placeholder="Phone Number*" required>
